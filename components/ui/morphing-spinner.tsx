// Componente de loading com animação de morphing
// Usado para indicar processamento de pagamento PIX
...
export function MorphingSpinner({ size = "md", className }: MorphingSpinnerProps) {
  ...
  return (
    <div className={cn("relative", sizeClasses[size], className)}>
      <div className="absolute inset-0 animate-[smoothMorph_3s_ease-in-out_infinite] bg-[var(--color-brand-primary)]" />
